  ...
  return (
    <nav className="fixed top-0 w-full bg-gray-700/50 backdrop-blur-md text-white flex items-center justify-between px-6 py-4 shadow-md z-50">
      ...
      <ul className="flex space-x-6">
        ...
        <li><a href="/resume.pdf" download className="inline-flex items-center gap-2 px-2 py-0.5 border-3 border-amber-900 text-slate-300 rounded-md font-semibold hover:bg-amber-900  hover:text-white transition duration-300"
        >
          <FaDownload/>
          Resume
        </a>
